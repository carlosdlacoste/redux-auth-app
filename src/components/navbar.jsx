                ...
                <div className="mx-auto max-w-7xl p-2 sm:px-8 lg:px-8">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="space-x-4">
                            ...
                            :
                            <>
                                    <button className="bg-red-700 hover:bg-slate-300 py-2 px-4 rounded-md border-2 border-slate-50 text-sm" onClick={() => dispatch(removeUserFromStorage())}>Log Out</button>
                            </>
