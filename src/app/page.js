        ...
        {!token &&
          <>
            <div className="home-image">
              <h1 className="text-2xl text-center text-slate-900 font-bold p-6">Welcome to the state-of-the-art Redux Auth System!</h1>
                <p className="text-center text-xl text-slate-900 font-semibold">
              ...
              <div className="flex flex-col justify-center items-center px-6 py-10">
                <h2 className="mb-4 text-lg font-bold text-black dark:text-white">Discover our functionalities:</h2>
                <ul className="max-w-md space-y-8 text-gray-900 list-inside font-semibold dark:text-gray-400">
                    <li>
